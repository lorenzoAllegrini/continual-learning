...
for root, dirs, files in os.walk(base_dir):
    ...
    if "results.csv" in files:
        ...
        if {'true_positives', 'false_positives', 'false_negatives', 'train_time', 'train_epochs'}.issubset(results_df.columns):
            tp = 0
            fp = 0
            fn = 0
            tn = 0
